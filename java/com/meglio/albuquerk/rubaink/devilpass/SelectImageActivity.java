            ...
            public void onClick(View v) {
                if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.M){
                    if(ContextCompat.checkSelfPermission(SelectImageActivity.this,
                        ...
                        Toast.makeText(SelectImageActivity.this, "Permission denied",
        ...
        suivant.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (selectImage != null){
                    ...
                    Intent nt = new Intent(SelectImageActivity.this,
                            SelectTicketActivity.class);
                    nt.putExtra("image",mainImage);
                    nt.putExtra("event",inf);
                    startActivity(nt);
                }else
                    Toast.makeText(SelectImageActivity.this, "Select event image",
                            Toast.LENGTH_LONG).show();
            }
        });
    }
        ...
        if (requestCode == CropImage.CROP_IMAGE_ACTIVITY_REQUEST_CODE) {
            ...
            if (resultCode == RESULT_OK) {
                ...
                if (!SelectImageActivity.this.isFinishing()){
                    Glide.with(SelectImageActivity.this).load(selectImage).into(imageView);
                }


            } else if (resultCode == CropImage.CROP_IMAGE_ACTIVITY_RESULT_ERROR_CODE) {
                Exception error = result.getError();
                Toast.makeText(SelectImageActivity.this, "(Error): " + error,
                        Toast.LENGTH_LONG).show();
            }
        }
    }
