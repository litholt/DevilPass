...
public class SetupActivity extends AppCompatActivity {
    ...
    private ImageView user_image,back,current_setting;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        current_setting.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent nt = new Intent(SetupActivity.this, SetupUActivity.class);
                startActivity(nt);
            }
        });

        opt_av = findViewById(R.id.opt_avance);
        opt_av.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent mt = new Intent(SetupActivity.this, FuturActivity.class);
                startActivity(mt);
            }
        });
        current_setting.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent mt = new Intent(SetupActivity.this, SetupUActivity.class);
                startActivity(mt);
            }
        });
        ...
        /*adapter = new ArrayAdapter<>(this,android.R.layout.simple_list_item_1,genre);
        ...
        final String cc = getUserCountry(SetupActivity.this);
        user_denario = null;
                    ...
                    public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                        if(task.isSuccessful()){
                            if(Objects.requireNonNull(task.getResult()).exists()){
                                ...
                                //user_country = task.getResult().getString("country");
                                ...
                                if (!SetupActivity.this.isFinishing()){
                                    Glide.with(SetupActivity.this).load(image).into(user_image);
                                }
                            }
                        }
                    }
            ...
            public void onClick(View v) {
                ...
                /*countryCodePicker.setOnCountryChangeListener( new CountryCodePicker.OnCountryChangeListener() {
                    ...
                    public void onCountrySelected() {
                        countryCodeAndroid = countryCodePicker.getSelectedCountryCode();
                    }
                });*/
